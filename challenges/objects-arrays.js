...
// * Making an executive decision and storing the weight/length as numbers instead of strings, because that doesn't seem practical in real world applications
...
console.log(`The ${dino1.name} weighs ${dino1.weight} kgs.`);

// What was the diet of a velociraptor?
console.log(`The diet of a ${dino3.name} is ${dino3.diet}.`);

// How long was a stegosaurus?
console.log(`The ${dino2.name} was ${dino2.length}m long.`);
